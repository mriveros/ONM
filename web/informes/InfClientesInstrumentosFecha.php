...
function Header()
{
   // Select Arial bold 15
    ...
    $this->text(108,60,'Instrumentos Registrados por Clientes');//Titulo
...
{   
    ...
    $pdf->Cell(55,5,$instrumento,1,0,'L',$fill);
    $pdf->Cell(100,5,$obs,1,0,'L',$fill);
    $pdf->Cell(25,5,$recepcion,1,0,'C',$fill);
    $pdf->Cell(25,5,$trabajo,1,0,'C',$fill);
