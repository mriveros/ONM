...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Registro de Ingresos - <small>ONM WORKFLOW</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <form class="form-horizontal" action="DetalleRegistro.php"  method="post" role="form" >
                    ...
                    $query = "select ing.ing_cod,ing.ing_proforma,ing.cli_cod,cli.cli_nom || ' '|| cli.cli_ape as nombres,
                            ...
                            from ingreso ing, clientes cli where cli.cli_cod=ing.cli_cod and situacion <> 'ENTREGADO'";
