...
$query = "INSERT INTO ingreso(ing_proforma,cli_cod,usu_cod,fecha_recepcion,fecha_entrega,estado,situacion,ing_obs)VALUES ($proforma,$cliente,1,now(),'$fechaentrega','t','RECEPCION','$obs');";
