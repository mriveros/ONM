 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Laboratorio ya existe. Intente ingresar otro Laboratorio");
                window.location="http://192.168.0.99/web/ONM/web/laboratorios/ABMlaboratorio.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://192.168.0.99/web/ONM/web/laboratorios/ABMlaboratorio.php");
                }
            }
        //si es Modificar    
