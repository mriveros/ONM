 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Instrumento ya existe. Intente ingresar otro Instrumento");
                window.location="http://localhost/app/ONMWORK-CONTROL/web/instrumentos/ABMinstrumento.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://localhost/app/ONMWORK-CONTROL/web/instrumentos/ABMinstrumento.php");
                }
            }
        //si es Modificar    
