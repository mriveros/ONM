        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Ranking de Instrumentos-Clientes
                        </div>
                        <!-- /.panel-heading -->
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="rankingInstrumentosClientes.php" method="post" role="form">
