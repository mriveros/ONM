...
header("Location:http://192.168.0.99/web/ONM/web/login_tecnicos/acceso.html");
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Informe de Instrumentos Calibrados
                        </div>
                        <!-- /.panel-heading -->
				...
				<div class="modal-header"><button type="button" class="close" data-dismiss="modal">
					...
					<h3 class="modal-title" id="myModalLabel"><i class="fa fa-archive"></i> Registros de Calibraciones por Fecha</h3>
				</div>
            
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="InfClientesInstrumentosFecha.php" method="post" role="form">
